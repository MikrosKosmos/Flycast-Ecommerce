...
export class ProductListComponent implements OnInit {
  ...
  productDetails: { productName: string, price: number, description: string, imageSrc: string }[];
  closeResult = '';
  constructor(
  ...
  ngOnInit(): void {
    ...
    this.productDetails = [
      ...
      { productName: "Samsung Galaxy Note 10 (Aura Black, 256 GB)  (8 GB RAM)", price: 75000, description: "Powered by a 7nm processor, 8 GB of RAM, 256 GB of internal storage capacity and a 2.0 Gbps LTE connection, the Note 10 lets you download files, live-game, and stream content seamlessly.", imageSrc: "assets/img/slide/product/mobiles/Samsung/galaxy-note-10-256.jpeg" },
      { productName: "Samsung Galaxy S20 Ultra (Cosmic Gray, 128 GB)  (12 GB RAM)", price: 97999, description: "Say hello to the powerful and stylish Samsung Galaxy S20 Ultra smartphone. Featuring a 108 MP high-resolution camera with 100X Zoom, you can capture stunning photos like never before on this smartphone. It also comes with a long-lasting 5000 mAh battery so you can stay entertained for a long time.", imageSrc: "assets/img/slide/product/mobiles/Samsung/samsung-galaxy-s20-ultra.jpeg" },
      { productName: "Motorola Razr 5G (Polished Graphite, 256 GB)  (8 GB RAM)", price: 124999, description: "The Moto razr 5G combines the classic flip phone design with the performance needed for today’s smartphone user. This 5G-ready phone features a premium design that will definitely make its on-lookers be in awe of it.", imageSrc: "assets/img/slide/product/mobiles/Motorola/motorola-razr-5g.jpeg" },
    ]
  }
